    ...
    */
    ...
    while (gtmvrender::me()->touchv() <= xiny120::AudioEngine::me()->mstart){
        if ((v = gtmvrender::me()->popv()) != NULL && v->len != 0){
            //void * pixels = NULL;
            //unsigned  char * rgb = new unsigned char[v->width * v->height * 3];
            //gtmvreader::yv12torgb24(rgb,v->data,v->width,v->height);
            ...
            //glTexImage2D(GL_TEXTURE_2D, 0, 3, v->width, v->height, 0, GL_RGB, GL_UNSIGNED_BYTE, v->data);
